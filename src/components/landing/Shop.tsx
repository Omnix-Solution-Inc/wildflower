    ...
    <section id="shop" className="py-24 px-[6%] bg-off-white">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-[0.85rem] leading-[1.9] text-charcoal/70 max-w-xl mx-auto mb-14">
          <Bi
            en="Finished arrangements available for pickup or local delivery in Ontario, Rochester, and Santa Cruz, NY. Each piece is designed with intention — crafted to bring beauty into your space."
            es="Arreglos terminados disponibles para recoger o entrega local en Ontario, Rochester y Santa Cruz, NY. Cada pieza está diseñada con intención — creada para llevar belleza a tu espacio."
          />
        </p>
