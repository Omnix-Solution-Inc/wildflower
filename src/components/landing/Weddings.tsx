      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        <div className="mt-16 max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
            ...
            <img src="/gallery/wedding_couple_lake_v2.jpg" alt="Couple by the lake at a forest wedding" className="w-full aspect-[3/5] object-cover col-span-2 md:col-span-1 mx-auto max-w-[240px]" />
          </div>
        </div>
    </section>
  )
