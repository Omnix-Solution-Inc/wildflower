      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-5 -right-3 md:-right-5 bg-linen px-7 py-5">
            <span className="font-script text-2xl text-terracotta block leading-tight"><Bi en="Your Big Day" es="Tu Gran Día" /></span>
          </div>
        </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-5">
            <img src="/gallery/wedding_ring_ceremony.jpg" alt="Real wedding ring exchange ceremony" className="w-full aspect-[3/5] object-cover rounded-lg" />
